...
class GeneticModelTrainer:
    ...
    def plot_training_history(self):
        ...
        try:
            ...
            # Plot loss
            axes[0, 0].plot(self.history.history['loss'], 'b-', label='Training Loss')
            axes[0, 0].plot(self.history.history['val_loss'], 'r--', label='Validation Loss')
            ...
            # Plot MAE
            axes[0, 1].plot(self.history.history['mae'], 'b-', label='Training MAE')
            axes[0, 1].plot(self.history.history['val_mae'], 'r--', label='Validation MAE')
            ...
            # Plot MSE
            axes[1, 0].plot(self.history.history['mse'], 'b-', label='Training MSE')
            axes[1, 0].plot(self.history.history['val_mse'], 'r--', label='Validation MSE')
            axes[1, 0].set_title('Mean Squared Error Over Epochs')
            axes[1, 0].set_xlabel('Epoch')
            axes[1, 0].set_ylabel('MSE')
            axes[1, 0].legend()

            # Plot learning curves
            axes[1, 1].plot(self.history.history['loss'], 'b-', label='Training')
            axes[1, 1].plot(self.history.history['val_loss'], 'r--', label='Validation')
            ...
            print("\nTraining history plots saved to 'plots/training_history.png'")

        except Exception as e:
            print(f"Error creating plots: {str(e)}")
            print("Please ensure you have the required plotting libraries installed.")
